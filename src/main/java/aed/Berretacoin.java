...
public class Berretacoin {
    ...
    public Berretacoin(int usuariosAGenerar) { /*COMPLEJIDAD DEL MÉTODO PERTENECE AL ORDEN O(P), P SIENDO usuariosAGenerar */
        ...
        List<Usuario> usuariosCargados = new ArrayList<>(); /*Operación básica, O(1) */
    ...
    public void agregarBloque(Transaccion[] transacciones) { /*COMPLEJIDAD DEL MÉTODO PERTENECE AL ORDEN O(N * LOG P), n siendo la cantidad
        ...
        List<Transaccion> transaccionesValidas = new ArrayList<>(); /*Operación básica, O(1)*/
        ...
        for (Transaccion t : transacciones) { /*Itero sobre las transacciones recibidas, O(n)*/
            ...
            transaccionesValidas.add(t); /*Operación básica, O(1)*/
        ...
        List<Heap<Transaccion>.HandleHeap> handles = heapTransacciones.insertarDesdeLista(transaccionesValidas); /*Complejidad O(n) */

        for (int i = 0; i < transaccionesValidas.size(); i++) { /*Complejidad O(n) */
            transaccionesValidas.get(i).setearHandleHeapT(handles.get(i)); /*Operación básica, O(1) */
        }
    ...
    public void hackearTx() { /*COMPLEJIDAD DEL MÉTODO PERTENECE AL ORDEN O(log n + log p) */
        ...
        Heap<Transaccion>.HandleHeap h = ultimoBloque.transaccionesHeap.extraerMaximo(); /* o(log n) */
